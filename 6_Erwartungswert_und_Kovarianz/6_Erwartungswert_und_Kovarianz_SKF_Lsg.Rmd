...
Nach dem zweiten Satz des Theorems zu Varianzeigenschaften (Linearkombination bei Unabhängigkeit) gil für unabhängige Zufallsvariablen $\xi_1,...,\xi_n$ und $a_1,...,a_n \in \mathbb{R}$
\begin{align*}
