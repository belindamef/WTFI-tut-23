...
\normalsize
\color{darkcyan}
Die ZV $\xi : \Omega \to \mathcal{X}$ beschreibe die Augenzahl eines Würfels, wobei $\mathcal{X} := \{1,2,3,4,5,6\}$
\vspace{1cm}
...
\textcolor{darkcyan}{Beantwortet die Frage "Für welchen Wert x ist die Wahrscheinlichkeit dafür, dass die ZV kleiner oder gleich diesem Wert annimmt, 0.975?}
\end{itemize}
