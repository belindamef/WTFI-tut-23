...
# \textcolor{darkblue}{SKF 19}. *zweiseitiger Einstichproben-T-Test (ZETT)* 

\large
\color{darkblue} 19. Definieren Sie den zweiseitigen Einstichproben-T-Test (ZETT).
...
```{r, echo = FALSE, out.width = "80%"}
knitr::include_graphics(file.path(abb_dir, "wtfi_12_nichtzentrale_t_verteilung.pdf"))
```




# \textcolor{darkblue}{SKF 20}. *Testgütefunktionen eines ZETTs* 

\large
\color{darkblue} 20. Skizzieren Sie qualitativ die Testgütefunktionen eines ZETTs für verschiedene kritische Werte.
...
# \textcolor{darkblue}{SKF 21}. *Level-$\alpha_0$-Test* 

\large
\color{darkblue} 21. Wie muss der kritische Wert eines ZETTs definiert sein, damit der Test ein Level-$\alpha_0$-Test ist?
...
# \textcolor{darkblue}{SKF 22}. *$k_{\alpha_0}$ bei einem zws Einstichproben-T-Test* 

\large
\color{darkblue} 22. Skizzieren Sie qualitativ die Bestimmung des kritischen Wertes $k_{\alpha_0}$ bei einem zws Einstichproben-T-Test.
...
```{r, echo = FALSE, out.width = "100%"}
knitr::include_graphics(file.path(abb_dir, "wtfi_12_t_test_ungerichtet_testumfangkontrolle.pdf"))
```




# \textcolor{darkblue}{SKF 23}. *Durchführung eines ZETTs* 

\large
\color{darkblue} 23. Erläutern Sie das praktische Vorgehen zur Durchführung eines ZETTs.
\vspace{3mm}
\color{black}
\footnotesize
...
# \textcolor{darkblue}{SKF 24}. *Powerfunktion des ZETTs* 

\large
\color{darkblue} 24. Von welchen Werten hängt die Powerfunktion eines ZETTs ab?
\vspace{3mm}
\color{black}
\footnotesize

Die Powerfunktion eines zweiseitigen Einstichproben T-Tests hängt bei festgelegtem $\alpha_0$ vom wahren, aber unbekannten Parameterwert $\delta = \sqrt{n}\frac{\mu-\mu_0}{\sigma}$ und von der Stichprobengröße $n$ ab. 




# \textcolor{darkblue}{SKF 25}. *Powerfunktion des ZETTs* 

\large
\color{darkblue} 25. Skizzieren Sie qualitativ die Powerfunktion des ZETTs bei fester Stichprobengröße.
...
dev.copy2pdf(
file        = file.path(file.path(abb_dir,  "alm_9_t_test_ungerichtet_powerfunktionen_skf15.pdf")),
width       = 8,
height      = 7)
...
# \textcolor{darkblue}{SKF 26}. *Powerfunktion des ZETTs* 

\large
\color{darkblue} 26. Skizzieren Sie qualitativ die Powerfunktion des ZETTs bei festem Erwartungswertparameter.
...
# \textcolor{darkblue}{SKF 27}. *Durchführung einer Poweranalyse* 

\large
\color{darkblue} 27. Erläutern Sie das favorisierte praktische Vorgehen zur Durchführung einer Poweranalyse.
...
# \textcolor{darkblue}{SKF 28}. *p-Wert Motivation* 

\large
\color{darkblue} 28. Erläutern Sie die Motivation zur Auswertung von p-Werten.
...
# \textcolor{darkblue}{SKF 29}. *p-Wert Definition* 

\large
\color{darkblue} 29. Definieren Sie den Begriff des p-Werts.
...
\small
\textcolor{darkcyan}{Beispiel (Zweiseitiger Einstichproben-T-Test mit einfacher Nullhypothese)}

\footnotesize
* \color{darkcyan} Bei $T = t$ würde $H_0$ für jedes $\alpha_0$ mit $|t| \ge \Psi^{-1}\left(1- \frac{\alpha_0}{2};n-1\right)$
...
# \textcolor{darkblue}{SKF 30}. *Dualität von Konfidenzintervallen und Hypothesentests* 

\large
\color{darkblue} 30. Geben Sie das Theorem zur Dualität von Konfidenzintervallen und Hypothesentests wieder.
...
# \textcolor{darkblue}{SKF 31}. *Dualität von Konfidenzintervallen und Hypothesentests* 

\large
\color{darkblue} 31. Erläutern Sie die Dualität von Konfidenzintervallen und Hypothesentests.

\vspace{3mm}
\color{black}
\footnotesize

Mit $\delta$-Konfidenzintervallen können Tests vom Signifikanzniveau $\alpha_0 = 1-\delta$ konstruiert werden. 

Dieser Test ergibt den Wert $0$ (Nullhypothese *nicht* ablehnen), wenn das Konfidenzintervall einen Nullhypothesenparameterwert einschließt und den Wert $1$, wenn (Nullhypothese ablehnen), wenn das Konfidenzintervall den Nullhypothesenparameterwert nicht überdeckt.
